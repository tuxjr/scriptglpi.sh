...
###############################################################################
########## Scrip shell modificado para instalacao do GLPI em Centos ###########
########## Este script criara um log no diretório atual para   ################
########## pesquisa de senha do banco de dados!!! By Tuxjr     ################
###############################################################################
###############################################################################
